<x-layouts::app :title="__('New Movie')">
	@vite(['resources/css/app.css', 'resources/js/app.js'])

	<div class="mx-auto w-full max-w-2xl p-6">
		<h1 class="mb-6 text-2xl font-semibold">Create Movie</h1>
		...
		<form method="POST" action="{{ route('movies.store') }}" enctype="multipart/form-data" class="space-y-4">
			@csrf
			...
			<div>
				...
				<input id="duration" name="duration" type="text" value="{{ old('duration') }}" placeholder="01:30" required
					class="w-full rounded border border-zinc-300 p-2 text-zinc-900" />
			</div>
