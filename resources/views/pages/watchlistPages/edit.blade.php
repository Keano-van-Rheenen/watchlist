<x-layouts::app :title="__('Edit')">
    ...
    <div class="mx-auto w-full max-w-2xl p-6">
        ...
        <form method="POST" action="{{ route('watchables.update', $watchable) }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('index') }}" class="rounded border border-zinc-300 px-4 py-2">Cancel</a>
            </div>
        </form>
    </div>
</x-layouts::app>
